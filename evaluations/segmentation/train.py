...
from models import *
from evaluations.segmentation.timm_models import *
from evaluations.segmentation.linear_seg import *
...
def main():
    ...
    if cfg.model.backbone.pretrained_path:
        ...
        backbone_args = yaml.safe_load((Path(cfg.model.backbone.pretrained_path).parent / 'args.yaml').read_text())
