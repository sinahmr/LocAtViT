...
#
# Create validation directory; move .tar file; change directory; extract validation .tar
mkdir imagenet/val && mv ILSVRC2012_img_val.tar imagenet/val/ && cd imagenet/val && tar -xf ILSVRC2012_img_val.tar
